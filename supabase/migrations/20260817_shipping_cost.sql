-- ============================================================
-- Migrasi: Tambah kolom biaya pengiriman (shipping_cost)
-- Project: Ucup Kasir
--
-- Menambahkan kolom shipping_cost pada tabel transactions dan
-- memperbarui fungsi create_transaction agar menerima ongkir.
-- Aman dijalankan ulang (idempotent).
-- Jalankan di Supabase Dashboard -> SQL Editor.
-- ============================================================

-- 1) Tambah kolom ongkir (jika belum ada)
ALTER TABLE transactions
  ADD COLUMN IF NOT EXISTS shipping_cost numeric(12,2) NOT NULL DEFAULT 0;

-- 2) Perbarui fungsi create_transaction: hitung total = subtotal - diskon + ongkir
...
BEGIN
  ...
  v_total := GREATEST(v_total - COALESCE(p_discount, 0) + COALESCE(p_shipping_cost, 0), 0);
  ...
  INSERT INTO transactions (
    user_id, customer_id, customer_name, subtotal, discount, shipping_cost, total,
    ...
    COALESCE(p_discount, 0), COALESCE(p_shipping_cost, 0), v_total,
