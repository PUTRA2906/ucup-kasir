-- ============================================================
-- Migrasi: Update create_transaction dengan custom date
-- Project: Ucup Kasir
--
-- Menambahkan parameter p_transaction_date ke create_transaction
-- agar tanggal transaksi bisa diubah saat pembuatan invoice.
-- ============================================================
