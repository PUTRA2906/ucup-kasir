-- ============================================================
-- Migrasi: Tambah kolom return_amount ke tabel transactions
-- Project: Ucup Kasir
--
-- Menambah kolom return_amount untuk menyimpan jumlah retur
-- secara terpisah dari diskon.
-- ============================================================

-- 1) Tambah kolom return_amount jika belum ada
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS return_amount numeric(12,2) NOT NULL DEFAULT 0;

-- 2) Update fungsi create_transaction
